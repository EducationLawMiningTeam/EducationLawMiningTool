...
# synthesize features
trainFGGAN.netG = torch.load(f'results_{opt.zero_shot_type}_{opt.use_type}/G_64_269_{opt.zero_shot_type}.pth').cuda()
syn_feature, syn_action, syn_obj = trainFGGAN.generate_syn_feature(unseen_att_labels, unseen_attributes, unseenLabels_obj, opt.syn_num , no_grad=True)


trainHoiCls(syn_feature, syn_action, syn_obj)
