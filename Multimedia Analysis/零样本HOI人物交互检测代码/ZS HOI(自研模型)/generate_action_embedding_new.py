...
text_dict = {(4, 4): 'a photo of a person boarding an airplane',
...
for i in range(117):
    for id in text_dict.keys():
        if id[0] == i:
            temp = text_dict[id]
            sentence = ' '.join(temp.split(' ')[0:6]) + ' something'
            sentences.append(sentence)
            break

# from index2some import verb_dict   # 测试动词是否正确
# for i in range(117):
#     print(sentences[i].split()[5], verb_dict[i])
...
np.save('hoi_action_embedding_new.npy', text_features)
