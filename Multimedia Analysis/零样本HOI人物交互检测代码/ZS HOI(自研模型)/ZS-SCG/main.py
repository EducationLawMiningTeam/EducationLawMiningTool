...
if __name__ == '__main__':
    ...
    parser.add_argument('--train-detection-dir', default='hicodet/detections/train2015_gt', type=str)
    parser.add_argument('--val-detection-dir', default='hicodet/detections/test2015_gt', type=str)
    ...
    parser.add_argument('--cache-dir', type=str, default='uv2')
    parser.add_argument('--zero-shot-type', type=str, default='')
...
# CUDA_VISIBLE_DEVICES='0,1,3' python main.py  --world-size 3 --batch-size 8  &>uv2/log &
