...
class MambaClassificationHead(nn.Module):
    def __init__(self, d_model, num_classes, **kwargs):
        ...
        self.out_proj = nn.Linear(d_model, num_classes, **kwargs)
...
class MambaTextClassification(MambaLMHeadModel):
    ...
    def forward(self, input_ids, visual, acoustic, visual_ids, acoustic_ids, pos_tag_ids=None, 
                senti_word_ids=None, polarity_ids=None, attention_mask=None, token_type_ids=None,
                position_ids=None, head_mask=None, labels=None):
        hidden_states = self.backbone(input_ids, visual_ids, acoustic_ids)
