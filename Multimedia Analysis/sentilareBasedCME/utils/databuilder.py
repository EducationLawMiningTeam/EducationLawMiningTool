...
def prepare_sentilare_input(args, tokens, visual_ids, acoustic_ids, pos_ids, senti_ids,  visual, acoustic, tokenizer):
    ...
    pad_length = args.max_seq_length - len(tokens)
    padding = [PAD] * pad_length
...
def get_tokenizer(args):
    return RobertaTokenizer.from_pretrained(args.model_name_or_path, do_lower_case=False, add_special_tokens=True)
