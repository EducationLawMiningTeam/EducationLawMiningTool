...
import torchvision
from networks.subnet.CEmodulemodulemodified import CME
...
class BertLayer(nn.Module):
    def __init__(self, config):
        ...
        # vit_b_16 = torchvision.models.vit_b_16(pretrained=False)
        ...
        # self.layert0 = vit_adapter_conv(transformer_encoder=vit.layers[0])
        # self.layert1 = vit_adapter_conv(transformer_encoder=vit.layers[1])

    def forward(self, hidden_states, attention_mask, head_mask=None):
        attention_outputs = self.attention(hidden_states, attention_mask, head_mask)
        attention_output = attention_outputs[0]
        # utadapter_output1 = self.layert0(hidden_states)
        # attention_output = attention_output + utadapter_output1
    ...
    def forward(self, hidden_states, visual=None, acoustic=None, visual_ids=None, acoustic_ids=None, attention_mask=None, head_mask=None):
        ...
        for i, layer_module in enumerate(self.layer):
            ...
            if i == ROBERTA_INJECTION_INDEX:
                hidden_states, visualcolle, acousticcolle = self.CME(hidden_states, visual=visual, acoustic=acoustic, visual_ids=visual_ids, acoustic_ids=acoustic_ids)
        ...
        return outputs, visualcolle, acousticcolle # last-layer hidden state, (all hidden states), (all attentions)
        # return outputs
