...
class RobertaForSequenceClassification(BertPreTrainedModel):
    ...
    def __init__(self, config, pos_tag_embedding=False, senti_embedding=False, polarity_embedding=False):
        ...
        self.concat = nn.Linear(3 * 768, 768)
    ...
    def forward(self, input_ids, visual=None, acoustic=None, visual_ids=None, acoustic_ids=None, pos_tag_ids=None, 
        ...
        visualcolle = outputs[1]
        acousticcolle = outputs[2]
        mix = torch.cat((sequence_output, visualcolle, acousticcolle), dim=-1)
        mixed = self.concat(mix)
        logits = self.classifier(mixed, visual, visual_ids)
        ...
        # return outputs, visualcolle, acousticcolle  # (loss), logits, (hidden_states), (attentions)
        return outputs
