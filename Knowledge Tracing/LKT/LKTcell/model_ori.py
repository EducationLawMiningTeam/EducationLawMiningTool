...
class MyTransformerDecoderLayer(nn.Module):
    ...
    def forward(self, tgt, memory, Time_done, Last, Repeat, tgt_att_mask=None, memory_att_mask=None,
...
class Model_exp(nn.Module):
    def __init__(self, q_num, time_spend, d_model, length, nhead, num_encoder_layers, dropout, speed_cate,
        ...
        #  ================ encoder =====================
        encoder_layer = MyTransformerEncoderLayer(d_model=d_model, nhead=nhead, dim_feedforward=512, dropout=dropout,
                                                  length=length)
