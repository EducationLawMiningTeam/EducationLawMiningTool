...
class EncoderEmbedding(nn.Module):
    def __init__(self, q_num, time_spend, length, d_model, memory_size):
        ...
        self.skill_embed = nn.Embedding(memory_size, d_model)
...
class Model_exp(nn.Module):
    def __init__(self, q_num, time_spend, d_model, length, nhead, num_encoder_layers, dropout, speed_cate,
        ...
        self.encoder_embedding = EncoderEmbedding(q_num=q_num,
                                                  ...
                                                  length=length, d_model=d_model, memory_size=memory_size)
        #  ================ encoder =====================
